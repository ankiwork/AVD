 ...
 * Generated from K:/sd/MCP/Devices/MCPJ/libs/open62541/src/tools/schema/NodeIds.csv with script K:/sd/MCP/Devices/MCPJ/libs/open62541/src/tools/generate_nodeid_header.py
 *-------------------------------------------------------*/
 ...
 * following definitions are autogenerated from the ``K:/sd/MCP/Devices/MCPJ/libs/open62541/src/tools/schema/NodeIds.csv`` file */
