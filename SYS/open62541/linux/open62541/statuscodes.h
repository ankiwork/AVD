 ...
 * Generated from /data/users/plais/projects/sd/MCP/Devices/MCPJ/libs/open62541/src/tools/schema/StatusCode.csv with script /data/users/plais/projects/sd/MCP/Devices/MCPJ/libs/open62541/src/tools/generate_statuscode_descriptions.py
 *-------------------------------------------------------*/
